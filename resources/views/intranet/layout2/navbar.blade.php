            ...
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                            ...
                            <div class="p-0 card-body">
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                            src="{{ asset('hope/assets/images/shapes/01.png') }}"
                                            alt="">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <div class="">
                                            <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                src="{{ asset('hope/assets/images/shapes/02.png') }}"
                                                alt="">
                                        </div>
                                        <div class="ms-3 w-100">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                            src="{{ asset('hope/assets/images/shapes/03.png') }}"
                                            alt="">
                                        <div class="ms-3 w-100">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                            src="{{ asset('hope/assets/images/shapes/04.png') }}"
                                            alt="">
                            ...
                            <div class="p-0 card-body ">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex align-items-center">
                                        <div class="">
                                            <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                src="{{ asset('hope/assets/images/shapes/05.png') }}"
                                                alt="">
                                        </div>
                                        <div class="ms-3">
                ...
                <li class="nav-item dropdown">
                    <a class="py-0 nav-link d-flex align-items-center" href="#"
                        ...
                        <img src="{{ asset('hope/assets/images/avatars/avtar_1.png') }}"
                            alt="User-Profile"
                            class="theme-color-purple-img img-fluid avatar avatar-50 avatar-rounded">
                        <img src="{{ asset('hope/assets/images/avatars/avtar_2.png') }}"
                            alt="User-Profile"
                            class="theme-color-blue-img img-fluid avatar avatar-50 avatar-rounded">
                        <img src="{{ asset('hope/assets/images/avatars/avtar_4.png') }}"
                            alt="User-Profile"
                            class="theme-color-green-img img-fluid avatar avatar-50 avatar-rounded">
                        <img src="{{ asset('hope/assets/images/avatars/avtar_5.png') }}"
                            alt="User-Profile"
                            class="theme-color-yellow-img img-fluid avatar avatar-50 avatar-rounded">
                        <img src="{{ asset('hope/assets/images/avatars/avtar_3.png') }}"
                            alt="User-Profile"
                            class="theme-color-pink-img img-fluid avatar avatar-50 avatar-rounded">
                        <div class="caption ms-3 d-none d-md-block ">
                            <h6 class="mb-0 caption-title">{{session('nombres_completos')}}</h6>
                            <p class="mb-0 caption-sub-title">{{session('rol_principal')}}</p>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="#">Cuenta de usuario</a></li>

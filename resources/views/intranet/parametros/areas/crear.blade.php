...
<a href="{{ route('area.index') }}" class="btn btn-success btn-xs btn-sombra text-center pl-5 pr-5 float-md-end" style="font-size: 0.8em;">
...
@section('script_pagina')
    <script src="{{ asset('js/intranet/parametros/area/crear.js') }}"></script>
@endsection

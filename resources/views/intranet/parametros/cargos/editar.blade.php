...
<i class="fas fa-sitemap mr-3" aria-hidden="true"></i> Parametros - Cargos - Editar
@endsection
...
@section('cuerpoPagina')
    @can('cargo.create')
        <div class="row d-flex justify-content-center">
            <form class="col-12 col-md-6 form-horizontal" action="{{ route('cargo.update',['id' => $cargo_edit->id]) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                @csrf
                @method('put')

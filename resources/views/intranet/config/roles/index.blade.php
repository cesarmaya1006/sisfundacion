                ...
                @foreach ($roles as $rol)
                    <tr>
                        ...
                        <td class="d-flex justify-content-evenly">
                             <a href="{{ route('rol.edit', ['id' => $rol->id]) }}" class="btn btn-sm btn-icon btn-info" data-bs-toggle="tooltip" data-bs-placement="top" data-original-title="Edit" aria-label="Edit" data-bs-original-title="Editar">
